...
if 'AZURE_POSTGRESQL_CONNECTIONSTRING' in os.environ:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('AZURE_POSTGRESQL_NAME', env('DB_NAME')),
            'USER': os.environ.get('AZURE_POSTGRESQL_USER', env('DB_USER')),
            'PASSWORD': os.environ.get('AZURE_POSTGRESQL_PASSWORD', env('DB_PASSWORD')),
            'HOST': os.environ.get('AZURE_POSTGRESQL_HOST', env('DB_HOST')),
            'PORT': os.environ.get('AZURE_POSTGRESQL_PORT', env('DB_PORT', default='5432')),
            'OPTIONS': {
                'sslmode': 'require',
            },
        }
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@optimum.com')
...
AZURE_FACE_API_KEY = os.environ.get('AZURE_FACE_API_KEY', env('AZURE_FACE_API_KEY'))
AZURE_FACE_ENDPOINT = os.environ.get('AZURE_FACE_ENDPOINT', env('AZURE_FACE_ENDPOINT'))
AZURE_FACE_PERSON_GROUP_ID = os.environ.get('AZURE_FACE_PERSON_GROUP_ID', env('AZURE_FACE_PERSON_GROUP_ID'))
